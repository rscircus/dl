# This Dockerfile is based upon base notebook from
...
LABEL maintainer="Roland Siegbert <roland@siegbert.info>"
ARG NB_USER="roland"
ARG NB_UID="1000"
ARG NB_GID="100"
...
# Create NB_USER wtih name roland user with UID=1000 and in the 'users' group
...
# Install conda as roland and check the md5 sum provided on the download site
...
# Switch back to roland to avoid accidental container runs as root
USER $NB_UID
